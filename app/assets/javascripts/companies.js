...
// All this logic will automatically be available in application.js.
$(function() {
  var deleteButtonSelector = '.btn-delete-company';
  ...
  function showDeleteModal(delete_button) {
    ...
    let companyName = $(delete_button).data('company-name');
    ...
    $('.modal').on('show.bs.modal', function (event) {
      ...
      let modalBody = "Are you sure you want to delete company " + companyName + "?";
